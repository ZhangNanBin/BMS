...
<script type="text/html" id="editInfo">
    ...
    <div style="width: 80%; margin: auto; text-align: center; margin-top: 5%">
		...
		<div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="price" id="price" required lay-verify="required"  autocomplete="off" class="layui-input">
            </div>
        </div>
		<div class="layui-form-item">
	...
	layui.use(['table','form','laydate'], function() {
		...
		table.render({
            ...
            cols: [[ //表头
                ...
                { field: 'publicationTime', title: '出版时间', fixed: 'left',templet: "<div>{{layui.util.toDateString(d.publicationTime, 'yyyy-MM-dd')}}</div>"  },
            ...
            if (obj.event === 'edit') {
                ...
                layer.open({
                    ...
                    success: function (layero) {
                        ...
                        const publicationTime = layui.util.toDateString(data.publicationTime, 'yyyy-MM-dd');
