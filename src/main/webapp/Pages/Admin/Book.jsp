...
<script>
	layui.use(['table','form'], function() {
		...
		table.render({
			...
			method : "post",
			page : true, //开启分页
	        url: "/bms/Book/getAll",//方法所在页面和方法名
			request : {
            ...
            cols: [[ //表头
                ...
                { field: 'state', title: '是否借出', fixed: 'left', templet: "<div>{{d.state?'已借':'未借'}}</div>"},
                ...
                case 'AddInfo':
                    ...
                    layer.open({
                        ...
                        yes: function () {
                            ...
                            $.ajax({
                                type: "post", //要用post方式                 
                                url: "/bms/Book/create",//方法所在页面和方法名
            ...
            if (obj.event === 'edit') {
                ...
                layer.open({
                    ...
                    yes: function () {
                        ...
                        $.ajax({
                            type: "post", //要用post方式                 
                            url: "/bms/Book/update",//方法所在页面和方法名
                            contentType: "application/json; charset=utf-8",
                            data: JSON.stringify(data),
                            dataType: "json",
                            success: function (data) {
